        ...
        public void initialize(SEResourceCache rsc) {
               ...
               public void tick (TimeVal time, double delta) {
                ...
                if(px1==MainScene.ptx&&py1==MainScene.pty) {
                        MainScene.bg = add_sprite_for_image(SEImage.for_resource("gameover"));
